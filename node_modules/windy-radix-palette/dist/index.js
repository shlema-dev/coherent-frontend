...
// /home/ross/personal/windy-radix-palette/node_modules/tailwindcss/lib/util/createPlugin.js
...
// /home/ross/personal/windy-radix-palette/node_modules/tailwindcss/lib/public/create-plugin.js
...
// /home/ross/personal/windy-radix-palette/node_modules/tailwindcss/plugin.js
...
__export(exports_colors, {
  ...
  crimsonDarkP3A: () => {
    {
      return crimsonDarkP3A;
    }
  },
  crimsonDarkP3: () => {
    {
      return crimsonDarkP3;
    }
  },
  crimsonDarkA: () => {
    {
...
var hexToRGBChannels = function(hex) {
  const r = hex.substring(1, 3);
  const g = hex.substring(3, 5);
  const b = hex.substring(5, 7);
  return `${parseInt(r, 16)} ${parseInt(g, 16)} ${parseInt(b, 16)}`;
};
function alias(color, step) {
...
var wrpPlugin = plugin.default.withOptions(({ colors = exports_colors, rootSelector = ":root" } = {}) => {
  const lightColors = {};
  const darkColors = {};
  const lightP3Colors = {};
  const darkP3Colors = {};
  for (const [colorName, steps] of Object.entries(colors)) {
    ...
    for (const [key, value] of Object.entries(steps)) {
      const color = key.includes("A") || colorName.includes("P3") ? value : hexToRGBChannels(value);
      map[`--${key}`] = color;
    }
  }
  ...
  for (const [colorName, colorObj] of Object.entries(colors)) {
    ...
    for (const key of Object.keys(colorObj)) {
      ...
      if (key.includes("A")) {
        ...
        themeColor[scale] = `rgb(var(--${colorName}${scale}) / <alpha-value>)`;
      }
    }
